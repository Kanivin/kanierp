...
scheduler_events = {
	"cron": {
		"0/15 * * * *": [
			"kanierp.manufacturing.doctype.bom_update_log.bom_update_log.resume_bom_cost_update_jobs",
		],
		"0/30 * * * *": [
			"kanierp.utilities.doctype.video.video.update_youtube_data",
		],
	...
	"hourly": [
		...
		"kanierp.projects.doctype.project.project.project_status_update_reminder",
		"kanierp.projects.doctype.project.project.hourly_reminder",
		"kanierp.projects.doctype.project.project.collect_project_status",
	],
	"hourly_long": [
	...
	"daily": [
		...
		"kanierp.crm.doctype.opportunity.opportunity.auto_close_opportunity",
		...
		"kanierp.projects.doctype.task.task.set_tasks_as_overdue",
		...
		"kanierp.assets.doctype.asset.asset.update_maintenance_status",
		"kanierp.assets.doctype.asset.asset.make_post_gl_entry",
		"kanierp.crm.doctype.contract.contract.update_status_for_contracts",
		"kanierp.projects.doctype.project.project.update_project_sales_billing",
		"kanierp.projects.doctype.project.project.send_project_status_email_to_users",
		"kanierp.quality_management.doctype.quality_review.quality_review.review",
		"kanierp.support.doctype.service_level_agreement.service_level_agreement.check_agreement_status",
		"kanierp.crm.doctype.email_campaign.email_campaign.send_email_to_leads_or_contacts",
		"kanierp.crm.doctype.email_campaign.email_campaign.set_email_campaign_status",
		...
		"kanierp.accounts.utils.auto_create_exchange_rate_revaluation_daily",
		"kanierp.accounts.utils.run_ledger_health_checks",
		"kanierp.assets.doctype.asset_maintenance_log.asset_maintenance_log.update_asset_maintenance_log_status",
	],
	"weekly": [
		"kanierp.accounts.utils.auto_create_exchange_rate_revaluation_weekly",
	],
	"daily_long": [
		"kanierp.accounts.doctype.process_subscription.process_subscription.create_subscription_process",
		"kanierp.setup.doctype.email_digest.email_digest.send",
		"kanierp.manufacturing.doctype.bom_update_tool.bom_update_tool.auto_update_latest_price_in_all_boms",
		"kanierp.crm.utils.open_leads_opportunities_based_on_todays_event",
		"kanierp.assets.doctype.asset.depreciation.post_depreciation_entries",
	],
	"monthly_long": [
		"kanierp.accounts.deferred_revenue.process_deferred_accounting",
		"kanierp.accounts.utils.auto_create_exchange_rate_revaluation_monthly",
	],
}

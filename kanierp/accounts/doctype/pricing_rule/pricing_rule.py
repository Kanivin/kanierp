...
class PricingRule(Document):
	...
	if TYPE_CHECKING:
		...
		from kanierp.accounts.doctype.pricing_rule_brand.pricing_rule_brand import PricingRuleBrand
		from kanierp.accounts.doctype.pricing_rule_item_code.pricing_rule_item_code import PricingRuleItemCode
		from kanierp.accounts.doctype.pricing_rule_item_group.pricing_rule_item_group import (
...
def get_pricing_rule_for_item(args, doc=None, for_validate=False):
	from kanierp.accounts.doctype.pricing_rule.utils import (
...
def apply_price_discount_rule(pricing_rule, item_details, args):
	...
	if pricing_rule.rate_or_discount == "Rate":
		...
		# TODO https://github.com/frappe/kanierp/pull/23636 solve this in some other way.

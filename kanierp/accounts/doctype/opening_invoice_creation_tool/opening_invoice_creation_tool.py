...
class OpeningInvoiceCreationTool(Document):
	...
	if TYPE_CHECKING:
		...
		from kanierp.accounts.doctype.opening_invoice_creation_tool_item.opening_invoice_creation_tool_item import (
		...
		invoice = frappe._dict(
			{
				...
				"update_stock": 0,  # important: https://github.com/frappe/kanierp/pull/23559

...
from kanierp.stock.doctype.item_price.item_price import ItemPriceDuplicateItem
from kanierp.stock.get_item_details import get_price_list_rate_for, process_args


class TestItemPrice(KanivinTestCase):
	def setUp(self):
		super().setUp()
	...
	def test_template_item_price(self):
		from kanierp.stock.doctype.item.test_item import make_item
